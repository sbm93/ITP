...
class TestStrategy(bt.Strategy):
    ...
    def __init__(self):
        ...
        self.he = bt.indicators.HurstExponent(self.dataclose,period=10)
    ...
    def next(self):
        ...
        if not self.position:
            if self.he[0] > 0.5 and self.sma5[0] > self.sma25[0]:
                ...
                if self.he[0] > 0.5 and self.dataclose[0] < self.dataopen[0] :
            ...
            if self.position.size < 0:
                ...
                if order == 0:
                    ...
                    #(self.datalow[0] <= sentryprice*(1 - self.p.sprofit_target) and self.datahigh[0] >= sentryprice*(1-self.p.sprofit_target)):
                        print('SPT')
                        ...
                        #(self.datalow[0] <= sentryprice*(1+self.p.sstop_loss) and self.datahigh[0] >= sentryprice*(1+self.p.sstop_loss)):
                            print('SSL')
