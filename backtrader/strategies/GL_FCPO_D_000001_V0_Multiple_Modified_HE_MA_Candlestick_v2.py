...
class TestStrategy(bt.Strategy):
    ...
    def next(self):
        ...
        if not self.position:
            if self.he[0] > 0.5 and self.sma5[0] > self.sma25[0] and self.dataclose[0] > self.dataopen[0]:
            ...
            if self.position.size < 0:
                #if(self.he[0] < minhe):
                #    minhe = self.he[0]
                #if(self.he[0] > self.he[-1] and self.he[-1] > minhe 
                if(self.he[0] < minhe):
                    minhe = self.he[0]
                ...
                if(order==0):
                    ...
                    # Short stop loss exit   
                        ...
                        if((self.datalow[0] <= sentryprice*(1+self.p.sstop_loss) and self.datahigh[0] >= sentryprice*(1+self.p.sstop_loss) and self.dataopen[0] < sentryprice*(1+self.p.sstop_loss)) or (self.dataopen[0] >= sentryprice*(1+self.p.sstop_loss))):                    
                            ...
                            print(sentryprice*(1+self.p.sstop_loss))
                            print((self.dataopen[0] >= sentryprice*(1+self.p.sstop_loss)))
