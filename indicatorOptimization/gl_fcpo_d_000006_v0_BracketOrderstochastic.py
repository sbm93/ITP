...
class BRACKET_ORDER_STOCHASTIC_STR(bt.Strategy):
    ...
    def next(self):
        ...
        if not self.position:
            if self.stoc.percK[0] < self.stoc.percD[0] and self.dataclose[0] > self.dataclose[-1] and self.datahigh[0] > self.datahigh[-1]\
            and self.datalow[0] > self.datalow[-1] :
                ...
                if self.stoc.percK[0] > self.stoc.percD[0] and self.dataclose[0] > self.dataopen[0] and self.dataclose[0] < self.dataclose[-1]:
            ...
            if self.position.size > 0:
                if self.stoc.percK[0] > self.stoc.percD[0] :#and self.dataclose[0] < self.dataopen[0]:
                    print("LongPExit" )
