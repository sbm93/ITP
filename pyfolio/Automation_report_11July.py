...
if strategy=='GL':
    ...
    str_list = [  sg_fcpo_d_000001_v1_Single.SG_FCPO_Single_v1 ]
...
for key, value in result_dict.items():
    ...
    createReports([round_trip_data['summary']],
                  [round_trip_data['pnl']],
                  [cob_data['annual_return']],
                  [cob_data['monthly_return'].fillna(0)],
                  [pd.DataFrame(cob_data['club_data']['is_weekly']).fillna(0)],
                  [round_trip_data['returns']],
                  [round_trip_data['duration']],
                  [round_trip_trades],
                  [returns])
