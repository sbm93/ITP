...
class CUSTOM_STRAT_FOURTEEN_VO_SRT(bt.Strategy):
    ...
    def __init__(self):
        ...
        self.sma5 = bt.indicators.SMA(self.ha.ha_close, period=3,plot=False)
        self.sma25 = bt.indicators.SMA(self.ha.ha_close, period=12,plot=False)
        #self.smaco = btind.CrossOver(self.sma5,self.sma25,plot=False)
        #self.highest = bt.indicators.Highest(self.datahigh,period=7)
        self.macdhist = bt.indicators.MACDHisto(period_me1=3,period_me2=20,period_signal=5)
