...
class CUSTOM_STRAT_NINE_VO_SRT(bt.Strategy):
    ...
    def __init__(self):
        ...
        self.highest = bt.indicators.Highest(self.datahigh,period=6)
        self.lowest = bt.indicators.Lowest(self.datalow,period=18)
        ...
        self.rsi = bt.indicators.RSI_EMA(self.dataclose,period=18)
